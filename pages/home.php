...
<div class="container-fluid">
	...
	<div class="row ml-sm-2 mr-sm-2 mt-lg-5">
		<div class="col-lg-12">
			...
			<p>
				Dif Jobs is de website die bedrijven, particulieren en studenten bij elkaar brengt zodat er productieve samenwerkingen onstaan waar iedereen
				baat bij hebben. Bedrijven en particulieren kunnen na het registreren van een account advertenties plaatsen met daarin vraagstukken opdrachten
				die door studenten kunnen worden uitgevoerd. De advertenties worden weergegeven op de jobs pagina. Studenten kunnen na het registreren van een
				account op advertenties reageren door een bericht te sturen naar het bedrijf dat de advertentie heeft geplaatst. Dit doe je door
